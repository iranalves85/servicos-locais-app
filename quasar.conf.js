  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        WEB_BANNER_ID: '6228456682', // Quadrado
        WEB_BANNERH_ID: '3963580958', // Horizontal
        WEB_INFEED_ID: '4874156180', // In-feed
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: [
        'SessionStorage', 'LocalStorage', 'Notify', 'Loading'
      ]
    },
    ...
    pwa: {
      ...
      manifest: {
        name: 'com.makingpie.local-services',
        short_name: 'com.makingpie.local-services',
        description: 'Serviços Locais e Fornecedores',
        display: 'standalone',
